document.addEventListener('DOMContentLoaded', () => {
    ...
    const updateCharacterVignette = () => {
        ...
        if (currentStep === 1) characters.professor.classList.add('active');
        if (currentStep === 2 || currentStep === 3) characters.walter.classList.add('active');
        if (currentStep === 4) characters.steve.classList.add('active');
    };
    ...
    document.getElementById('generateBtn').addEventListener('click', async () => {
        ...
        try {
            ...
            const requestData = {
                ...
                ink: userSelections.ink,
                fontUrl: userSelections.fontUrl,
